    ...
    <div className="flex h-full flex-col bg-stone-50">
      <header className="flex items-center gap-3 border-b border-stone-200 bg-white px-5 py-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-base font-semibold text-stone-900">Схемы событий датчиков</h1>
            <p className="text-xs text-stone-500">
              Это <b>контракты JSON-событий</b>, которые датчики и видеодетекторы шлют в RAGRAF — не сами устройства. Классы и подтипы группируют схемы; поля payload настраиваются под конкретный подтип. Добавить новый — «+ Добавить подтип» и описать его поля.
            </p>
          </div>
        </div>
