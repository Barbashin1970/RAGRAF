...
PARAM_UNITS: dict[str, str] = {
    ...
    # Ситуационный центр / ЕДДС Кольцово — koltsovo-edds-* фикстуры.
    # Источник: «Положение о ЕДДС МКУ "СВЕТОЧ"» №15 от 04.12.2020.
    "answerTimeSeconds": "с",
    "handlingTimeSeconds": "с",
    "dispatchTimeMinutes": "мин",
    "recordRetentionDays": "сут",
    "operatorsOnDuty": "чел.",
    "activationTimeMinutes": "мин",
    "monitoringIntervalMinutes": "мин",
    "reportIntervalHours": "ч",
    "powerSwitchoverSeconds": "с",
    "dutyShiftSize": "чел.",
    "verbalReportMinutes": "мин",
    "formalReportMinutes": "мин",
    "affectedPeopleThreshold": "чел.",
    "damageThresholdMillionRub": "млн ₽",
    "reportRefreshHours": "ч",
    "alarmDeliverySeconds": "с",
    "operatorConfirmMinutes": "мин",
    "fireDispatchMinutes": "мин",
    "devicesPerWorkstation": "шт.",
