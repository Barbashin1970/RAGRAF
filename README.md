...
Полная продуктовая спецификация: [`regulation-viz-skill.md`](regulation-viz-skill.md). Каталог технических навыков: [`SKILL.md`](SKILL.md). Подробное описание модели Σ + триггеры + композиция регламентов: [`RULES-MANAGEMENT.md`](RULES-MANAGEMENT.md). Сравнение с другими DSL: [`SKILL-D0SL.md`](SKILL-D0SL.md).
...
| Журнал срабатываний (event log) | ⏳ | в roadmap, [`BACKLOG.md`](BACKLOG.md) |
...
> **[RULES-MANAGEMENT.md](RULES-MANAGEMENT.md) §11 «Цифровой двойник процесса управления»** — пояснительная записка команде с примерами и архитектурным разбором.
