...
Существует REST API управления регламентами (`http://109.202.1.153:8958/docs`).
Регламенты описывают набор правил контроля промышленных параметров (давление, диаметр, отклонения).
